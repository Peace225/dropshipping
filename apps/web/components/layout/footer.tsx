...
export function Footer() {
  const jsonLd = {
    ...
    "priceRange": "$$",
    "description": "Plateforme sécurisée de bien-être maternel et infantile propulsée par l'IA, soutenant les mamans à Abidjan et partout dans le monde."
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            <div className="space-y-4">
              <span className="text-2xl font-bold font-serif tracking-wider text-white">AURAE</span>
              ...
              <div className="flex items-center gap-2 text-xs text-[#F5EBE6]/60">
                ...
                <span>Basé à Abidjan, Côte d'Ivoire</span>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-[#F5EBE6]/70 mb-4">Subscribe to our newsletter for expert tips and local updates across Abidjan & worldwide.</p>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-[#F5EBE6]/50 gap-4">
            <p>© {new Date().getFullYear()} AURAE. All rights reserved.</p>
            <p className="flex items-center gap-1">Crafted with <Heart className="w-3.5 h-3.5 text-[#6E857B] fill-[#6E857B]" /> for mothers in Abidjan & worldwide.</p>
          </div>
        </div>
      </footer>
    </>
