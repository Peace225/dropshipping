...
export default function ProductDetailPage() {
  ...
  const handleBuy = () => {
    ...
    // 1. Appel direct de la fonction du contexte panier pour que la page checkout le détecte
    ...
    // 2. Sauvegarde de secours dans le localStorage (au cas où le checkout le lit aussi)
    ...
    // 3. Redirection immédiate vers le checkout
    router.push("/checkout");
  };

  // ==========================================
  // FONCTIONS DE PARTAGE SOCIAL (Avec le SLUG)
  // ==========================================
  const getShareUrl = () => {
    if (typeof window !== 'undefined' && product?.slug) {
      return encodeURIComponent(`${window.location.origin}/shop/maternite/${product.slug}`);
    }
    return "";
  };
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center gap-4 pt-20">
        ...
        <Link href="/shop/maternite" className="px-6 py-2 bg-[#333333] text-white rounded-full font-bold">
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-16 pt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* En-tête : Fil d'Ariane et Connexion */}
        <div className="flex justify-between items-center mb-6">
          <Link href="/shop/maternite" className="inline-flex items-center gap-2 text-sm font-bold text-[#333333]/70 hover:text-[#333333] transition-colors">
          ...
          <div className="lg:col-span-3 bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col">
            ...
            <div className="p-4">
              ...
              <div className="border border-gray-200 rounded-lg divide-y divide-gray-200">
                ...
                {/* Dynamique : Point Relais ou À Domicile */}
        ...
        {/* ==========================================
            SECTION SUGGESTIONS EN CARROUSEL
        ========================================== */}
