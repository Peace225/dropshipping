        ...
        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-gray-200 shadow-lg mb-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            ...
            {cart.length > 0 && (
              <button
                onClick={clearCart}
                className="text-xs font-semibold text-red-500 hover:text-red-700 flex items-center gap-1.5 px-3 py-1.5 rounded-full hover:bg-red-50 transition-colors cursor-pointer"
              >
          ...
          {cart.length === 0 ? (
            <div className="text-center py-12 border-t border-gray-100">
              ...
              <Link
                href="/shop/maternite"
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs sm:text-sm transition-all shadow-md active:scale-95"
              >
